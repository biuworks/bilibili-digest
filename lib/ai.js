...
var BILI_AI = (() => {
  ...
  /** 取出提示词 markdown 内置「系统提示词」正文（不做变量替换）。 */
  function builtinSystemPrompt(markdown) {
    return extractPromptSection(markdown, "系统提示词", {});
  }
  function builtinAnalysisSystemPrompt(markdown) {
    return builtinSystemPrompt(markdown);
  }
