...
| 笔记搜索截图 | 1280×800 | `store/screenshots/04-notes-search.png` |
| 学习稿导出截图 | 1280×800 | `store/screenshots/05-learning-export.png` |
| 笔记 AI 优化截图（Edge 追加） | 1280×800 | `store/screenshots/06-notes-refine.png` |
